...
export default function RepartidorDashboard() {
  ...
  const currentOrderEarnings = activeOrder
    ? Number((activeOrder as unknown as { courier_earnings?: number }).courier_earnings ?? 0)
    : 0;
