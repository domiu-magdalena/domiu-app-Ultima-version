...
CREATE INDEX idx_commission_config_category ON commission_config(category);
CREATE INDEX idx_commission_config_business ON commission_config(business_id);
...
CREATE INDEX idx_commission_tx_order ON commission_transactions(order_id);
CREATE INDEX idx_commission_tx_business ON commission_transactions(business_id);
CREATE INDEX idx_commission_tx_status ON commission_transactions(status);
CREATE INDEX idx_commission_tx_created ON commission_transactions(created_at DESC);
...
CREATE INDEX idx_business_payouts_status ON business_payouts(status);
